...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <FormLabel htmlFor="wd-todo-completed" className="float-start me-2">Completed</FormLabel>
      <FormCheck id="wd-todo-completed" checked={todo.completed} className="float-start"
             onChange={(e: any) => setTodo({ ...todo, completed: e.target.checked })} />
      <br /><br />
